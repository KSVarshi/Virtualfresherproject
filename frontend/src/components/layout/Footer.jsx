      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center mb-4">
              <span className="text-2xl font-bold">ShopSmart AI</span>
            </Link>
            <p className="text-gray-300 mb-4">
              AI-powered shopping assistant that helps you find the best products at the best prices.
            </p>
            ...
            <form className="mb-4">
              <div className="flex">
                <input
                  ...
                  className="flex-grow p-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-secondary-400 text-gray-900"
                />
                <button
                  type="submit"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm mb-4 md:mb-0">
            &copy; {currentYear} ShopSmart AI. All rights reserved.
          </p>
          <div className="flex space-x-4">
